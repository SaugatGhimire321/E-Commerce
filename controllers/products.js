...
const createProduct = async (req,res)=>{
  ...
  const replaceProduct = async(req,res)=>{
    const {productID} = req.params
    const updatedProduct = await ProductModel.findOneAndReplace({_id:productID},req.body,{new:true})
    res.json(updatedProduct)
  }
  ...
  module.exports = {returnAllProducts,returnSingleProduct,createProduct,updateProduct,replaceProduct,deleteProduct}